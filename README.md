...
4.  Sincere questions are more about technology, material life, emotional need; Insincere questions are more about race, religion, politics. 
 ...
 <img src="https://github.com/ReinaFeng/Quora-Insincere-Questions-Classification/raw/master/image/topwords.png" alt="topwords.png" width="5548" style="zoom: 33%;" /> 
...
* Embedding Models:
  ...
  <img src="https://github.com/ReinaFeng/Quora-Insincere-Questions-Classification/raw/master/image/1.png" alt="1.png" width="548" style="zoom: 50%;" />

   Compare different pre-train:
   
   <img src="https://github.com/ReinaFeng/Quora-Insincere-Questions-Classification/raw/master/image/2.0.png" alt="2.0.png" width="548" style="zoom:50%;" /> 

  Compare different embedding performance:

   <img src="https://github.com/ReinaFeng/Quora-Insincere-Questions-Classification/raw/master/image/3.png" alt="3.png" width="300" style="zoom:50%;" /> 
...
Since the data is imbalanced, 94% are the sincere target, so accuracy for four models are both high, but through the F1 score, could find the LR model is not good.
 ...
 <img src="https://github.com/ReinaFeng/Quora-Insincere-Questions-Classification/raw/master/image/6.png" alt="6.png" width="348" style="zoom: 33%;" /> 

#### Look at Result

Compared to LR Model, these texts are correctly predicted by this DL model.

 <img src="https://github.com/ReinaFeng/Quora-Insincere-Questions-Classification/raw/master/image/8.png" alt="8.png" width="448" style="zoom: 50%;" /> 

Misclassifies - it is hard to predict for human too:

  <img src="https://github.com/ReinaFeng/Quora-Insincere-Questions-Classification/raw/master/image/9.png" alt="9.png" width="500" style="zoom:50%;" /> 
